...

{
  ...
  <button
    ...
    className={`w-full py-1.5 px-3 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer border ${isPdf
              ...
              <div className="space-y-1.5">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded border ${isPdf ? 'bg-rose-100 text-rose-800 border-rose-200' : 'bg-indigo-100 text-indigo-800 border-indigo-200'
                        }`}>
                        {resItem.type || 'PDF'}
                      </span>
                      {resItem.size && (
