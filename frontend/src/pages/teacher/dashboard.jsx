            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                      <span className="w-8 h-8 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                      </span>
                      Community Hub
                    </h3>
                  ...
                  <p className="text-xs text-slate-500 mb-5">
                    Recent student questions needing guidance.
                  </p>
                  ...
                  <div className="space-y-3.5">
                    {dashboardData?.communityActivity && dashboardData.communityActivity.length > 0 ? (
                      dashboardData.communityActivity.map((post, index) => (
                        <div
                          key={post.id || index}
                          className="p-3 rounded-xl border border-slate-100/90 hover:border-indigo-200 bg-slate-50/40 hover:bg-white transition-all cursor-pointer group"
                          onClick={() => setActiveNav('community')}
                        >
                          <div className="flex justify-between items-baseline mb-1">
                            <h4 className="font-bold text-slate-800 text-xs group-hover:text-indigo-600 transition-colors truncate max-w-[280px]">
                              {post.title}
                            </h4>
                            <span className="text-[10px] text-slate-400 font-medium shrink-0 ml-1">{post.time}</span>
                          </div>
                          ...
                          <div className="flex items-center justify-between text-[10px]">
                            <span className="font-semibold text-slate-400 flex items-center gap-1">
                              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
