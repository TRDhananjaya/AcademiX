...
nb.cells = [
    nbf.v4.new_markdown_cell("# AcademiX Adaptive Follow-up Quiz ML Model"),
    nbf.v4.new_code_cell(code_1),
    nbf.v4.new_markdown_cell("## 1. Generate Dataset for Existing Students"),
    nbf.v4.new_code_cell(code_2),
    nbf.v4.new_markdown_cell("## 2. Feature Engineering"),
    nbf.v4.new_code_cell(code_3),
    nbf.v4.new_markdown_cell("## 3. Train Model"),
...
print("Notebook RFL.ipynb successfully generated.")
